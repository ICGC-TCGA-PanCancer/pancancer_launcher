...
Document sercurity groups! Add config in aws.cfg Also: Security group should have rule to SSH for itself so launcher and woker in same group can communicate.
-->
